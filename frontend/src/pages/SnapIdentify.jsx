      ...
      <main className="mx-auto max-w-6xl px-6 pb-20 pt-32">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-lg leading-7 text-slate-600">
            Take a photo or upload an image to discover the story
            behind India's heritage.
          </p>
            ...
            <div className="grid overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-xl md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-8 md:p-10">
                ...
                <p className="mt-3 leading-7 text-slate-600">
                  Bharat Roots will analyze your image and try to
                  identify the heritage site or cultural object.
                </p>
        ...
        {result && (
          ...
          <div className="mx-auto mt-12 max-w-5xl">
            ...
            <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-xl">
              ...
              <div className={`p-8 text-white bg-gradient-to-r ${
                result.success 
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-slate-100 opacity-90">
                      {result.success ? "IDENTIFICATION COMPLETE" : "IDENTIFICATION PROCESS"}
                    </p>

                    <h2 className="text-3xl font-black">
                      {result.success ? result.detected_name : "Landmark Not Recognized"}
                    </h2>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`rounded-full px-4 py-2 text-sm font-bold ${
                      ...
                      {result.success ? `${Math.round(result.confidence * 100)}% confidence` : "Unresolved landmark"}
                    </span>
                    ...
                    <>
                      <div className="mt-7">
                        ...
                        <p className="flex items-center gap-2 text-slate-600">
                          ...
                          {result.heritage?.city},{" "}
                          {result.heritage?.state}
                    ...
                    {result.success ? (
                      <>
                        ...
                        <button
                          onClick={() => {
                            if (result.heritage) {
                              navigate("/ai-guide", { state: { heritage: result.heritage } });
                            }
                          }}
                      ...
                      <div className="rounded-2xl bg-amber-50 border border-amber-200 p-4 text-amber-800 text-sm leading-6">
                        {result.message || "We could not find this heritage landmark in our records yet."}
                      </div>
                    )}
